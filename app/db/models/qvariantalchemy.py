...
class Integer(types.TypeDecorator):
    ...
    def process_bind_param(self, value, dialect):
        return gen_process_bind_param(int, lambda value: value.toLongLong(),self, value, dialect)
...
class Boolean(types.TypeDecorator):
    ...
    def process_bind_param(self, value, dialect):
        return gen_process_bind_param(int, lambda value: value.toBool(),self, value, dialect)


class String(types.TypeDecorator):
    impl = types.Unicode
    def process_bind_param(self, value, dialect):
        return gen_process_bind_param(str, lambda value: value.toString(),self, value, dialect)
...
class DateTime(types.DateTime):
    ...
    def process_bind_param(self, value, dialect):
        return gen_process_bind_param(datetime.datetime, lambda value: value.toDateTime(),self, value, dialect)
